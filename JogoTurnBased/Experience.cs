    ...
    public class Experience
    {
        ...
        private int[] LevelUpStats(string stats, int[] playerStats)
        {
            ...
            switch (stats)
            {
                ...
                case "Hp":
                case "hp":
                    playerStats[0] = playerStats[0] + randomStat.Next(0, 16);
                ...
                case "Dano":
                case "dano":
                    playerStats[1] = playerStats[1] + randomStat.Next(0, 6);
                ...
                case "Esquiva":
                case "esquiva":
                    playerStats[2] = playerStats[2] + randomStat.Next(0, 6);
                ...
                case "Cura":
                case "cura":
                    playerStats[3] = playerStats[3] + randomStat.Next(0, 6);
